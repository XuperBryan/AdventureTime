...
public class Gift
{
    ...
    String date;
    String message;
    public Gift(String Name, String Last, boolean gender,String NAME, String LAST, boolean GENDERR)
    {
        name = Name;
        last = Last;
        female = gender;
        ...
        flast = LAST;
        ffemale = GENDERR;
        if(getFullName().equalsIgnoreCase("Jessica Te ")){
            date = "12/27/16";
            message = "Happy 17th birthday";
        } else if((getFullName().equalsIgnoreCase("Cat Nguyen "))||
    ...
    public void one(){
        ...
        System.out.println();
        System.out.println("One day, " +getFirstName() +"and " +hisHer(false) +"best friend were walking down ");
    ...
    public void four(){
        ...
        System.out.println(fhisHer(false) +"gift...");
    ...
    public void five(){
        ...
        System.out.println("and " +getFirstName().substring(0,getFirstName().length()-1) +".");
        System.out.println("Wrong path! ");
        System.out.println();
        System.out.println("(1) Restart");
        System.out.println();
    ...
    public void fiftytwo(){
        ...
        System.out.println();
        System.out.println("Potatoes are an amazing gift! ");
        System.out.println();
    ...
    public static void main(String[] args){
        ...
        int selection=0;
        System.out.println("What is your best friend's full name? ");
        ...
        Gift jess = new Gift(namee,Last,Female,friendF,friendL,fFemale);
        System.out.println();
        ...
        while(cont==true){
            ...
            switch(selection)
            {
                ...
                case 12: jess.twelve();
                break;
                case 13: jess.thirteen();
                break;
                case 14: jess.fourteen();
                break;
                case 15: jess.fifteen();
                break;
                case 16: jess.sixteen();
                break;
                case 17: jess.seventeen();
                break;
                case 18: jess.eighteen();
                break;
                case 19:jess.nineteen();
                break;
                case 20: jess.twenty();
                break;
                case 21: jess.twentyone();
                break;
                case 22: jess.twentytwo();
                break;
                case 23: jess.twentythree();
                break;
                case 24: jess.twentyfour();
                break;
                case 25: jess.twentyfive();
                break;
                case 26: jess.twentysix();
                break;
                case 27: jess.twentyseven();
                break;
                case 28: jess.twentyeight();
                break;
                case 29: jess.twentynine();
                break;
                case 30: jess.thirty();
                break;
                case 31: jess.thirtyone();
                break;
                case 32: jess.thirtytwo();
                break;
                case 33: jess.thirtythree();
                break;
                case 34: jess.thirtyfour();
                break;
                case 35: jess.thirtyfive();
                break;
                case 36: jess.thirtysix();
                break;
                case 37: jess.thirtyseven();
                break;
                case 38: jess.thirtyeight();
                break;
                case 39: jess.thirtynine();
                break;
                case 40: jess.forty();
                break;
                case 41: jess.fortyone();
                break;
                case 42: jess.fortytwo();
                break;
                case 43: jess.fortythree();
                break;
                case 44: jess.fortyfour();
                break;
                case 45: jess.fortyfive();
                cont = false;
                break;
                case 46: jess.fortysix();
                break;
                case 47: jess.fortyseven();
                break;
                case 48: jess.fortyeight();
                break;
                case 49: jess.fortynine();
                break;
                case 50: jess.fifty();
                break;
                case 51: jess.fiftyone();
                break;
                case 52: jess.fiftytwo();
                cont = false;
                break;
            }
        }
